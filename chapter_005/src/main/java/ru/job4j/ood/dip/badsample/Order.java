 ...
 * выделить в интерфейс и реализовать сервис заказа, зависящий от него. Получится зависимость от хранилища
 * уже будет в сервисе заказа, а сервис магазина будет зависеть от сервиса заказов.
 */
public class Order {
    private int id;
