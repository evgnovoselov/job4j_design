 ...
 * возможность программно проверить максимальную зарплату, также использование приватного модификатор доступа позволяет
 * контролировать специфичные только для объекта поля.
 */
